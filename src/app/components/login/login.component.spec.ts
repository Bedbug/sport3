...
describe('LoginComponent', () => {
  ...
  it('User can login', () => {
    const expectedUser: User =
    {
      ...
      "password": "$2a$10$zXDjXdxFPDFVD4DbeizZ8eQ9jCGgw8qkvuulZtJZqY90FyjFJZWmi",
      "email": "aws@aws.com",
      "favTeams": [
        {
          "team": {
    ...
    authenticationService.login("RabidRabbit", ".").subscribe(user => {
      expect(user).toEqual(expectedUser, "Correct user object after login");      
    }, fail);
  })
