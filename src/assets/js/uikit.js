    ...
    var SliderDrag = {
        ...
        methods: {
            ...
            move: function (e) {
                ...
                // this.scrollables = document.querySelectorAll('.uk-panel-scrollable');
                // Array.from(this.scrollables).forEach(function (element) {
                //     // Now do something with my button
                //     removeClass(element, 'uk-panel-scrollable');
                // });
                ...
                // console.log(this.pos, this.drag);;
                if (distance === 0 || this.prevPos === this.pos || !this.dragging && Math.abs(distance) < this.threshold) {
                    return;
                }

               clearInterval(this$1.timeout);
                this$1.timeout = setTimeout(() => {
                   
                    this$1.unbindMove && this$1.unbindMove();
                    // this$1._show(false, this$1.index, true);
                    if (this$1.dragging) {

                        this$1.dragging = null;
    
                        if (this$1.index === this$1.prevIndex) {
                            this$1.percent = 1 - this$1.percent;
                            this$1.dir *= -1;
                            this$1._show(false, this$1.index, true);
                            this$1._transitioner = null;
                        } else {
    
                            var dirChange = (isRtl ? this$1.dir * (isRtl ? 1 : -1) : this$1.dir) < 0 === this$1.prevPos > this$1.pos;
                            this$1.index = dirChange ? this$1.index : this$1.prevIndex;
    
                            if (dirChange) {
                                this$1.percent = 1 - this$1.percent;
                            }
    
                            this$1.show(this$1.dir > 0 && !dirChange || this$1.dir < 0 && dirChange ? 'next' : 'previous', true);
                        }
                ...
                this.drag
                    ...
                    // Array.from(this.scrollables).forEach(function (element) {
                    //     // Now do something with my button
                    //     addClass(element, 'uk-panel-scrollable');
                    // });
